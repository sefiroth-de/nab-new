...
Genauer, es gibt (mindestens) eine Abbilung aus $\mathcal{L} = \{1, 2, \ldots, 49\}$ in $\mathcal{M} = \{1, 2, \ldots, 13\,983\,816\}$, so dass jede 6-elementige Teilmenge von $\mathcal{L}$ auf ein eindeutiges Element von $\mathcal{M}$ abgebildet wird.
