...
<<<<<<< HEAD
Ebenso kann wie <http://connect.raspberrypi.com> R PI Connect benutzt werden, sofern es vorab eingerichtet wurde.
=======
...
<<<<<<< HEAD
Später kann dann im Verzeichnis `pi-startup-display` einfach die aktuelle Version geladen werden durch:
=======
...
<<<<<<< HEAD
=======
Aber in den Regel beendet sich das Programm aber selber. Dank e-paper stehen die zuletzt aktuallisierten Daten aber weiterhin auf dem Display.
>>>>>>> 5520f36 (Merge)
